...
const steps: Step[] = [
  ...
  },
  {
    ...
    label: 'Get Summary',
    description: 'Receive a clear, concise summary you can read in minutes.',
  },
];
...
function StepItem({ icon, label, description }: Step) {
  return (
    <div className="relative p-6 rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-rose-500 transition-colors group w-full">
